...
public class ChangePage {
    ...
    public static void cambiaPagina(String fxml, IdSessioneBean id) throws IOException {
        ...
        controller.inizializza(id);                             //alla quale in base al pagina caricata associo l'istanza di uno dei controller grafici figli
